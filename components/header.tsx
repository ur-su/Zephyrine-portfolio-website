...
import { links, headerLanguageMap } from "@/lib/data";
...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      sm:top-6 sm:h-[3.25rem] sm:w-[30rem] sm:rounded-full dark:bg-gray-950 dark:border-black/40  dark:bg-opacity-70"
            ...
            >
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className="bg-gray-100 rounded-full absolute inset-0 -z-10 dark:bg-gray-800 dark:text-gray-300"
